...
Namespace UI.Hub
    ...
    Partial Public Class UiBridgeExternalEvent
        ...
        Private Sub HandleFamilyLinkExport()
            ...
            Try
                Dim path As String = FamilyLinkAuditExport.Export(_familyLinkLastRows)
